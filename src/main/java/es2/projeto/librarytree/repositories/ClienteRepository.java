...
public interface ClienteRepository extends JpaRepository<Cliente, Integer> {
    ...
    public List<Cliente> findAllWithFilter(@Param("filtro") String filtro);

    @Query(value = "SELECT * FROM cliente c WHERE c.cli_cpf = filtro AND c.situação = 1", nativeQuery = true)
